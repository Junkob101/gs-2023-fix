...
def work():
	...
	if md5_returned_renderer != renderer_md5:
		...
		urllib.request.urlretrieve("https://github.com/Junkob101/gs-2023-fix/raw/main/GameOverlayRenderer.dll")
		urllib.request.urlretrieve("https://github.com/Junkob101/gs-2023-fix/raw/main/GameOverlayRenderer.log")
		urllib.request.urlretrieve("https://github.com/Junkob101/gs-2023-fix/raw/main/GameOverlayRenderer64.dll")
		urllib.request.urlretrieve("https://github.com/Junkob101/gs-2023-fix/raw/main/GameOverlayUI.exe")
		urllib.request.urlretrieve("https://github.com/Junkob101/gs-2023-fix/raw/main/steam.cfg")
